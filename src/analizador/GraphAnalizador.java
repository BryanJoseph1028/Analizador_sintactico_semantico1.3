...
public class GraphAnalizador extends javax.swing.JFrame {
        ...
        String fichero2 = "Optimizado.txt"; //Pega en disco Raiz C. //Si no te lo toma, prueba con otra carpeta
    ...
    public GraphAnalizador() {
        ...
        String leerCod2 = "";
        try{
            File archivo2 = new File("Optimizado.txt"); //Aquí va la direccion de las tripletas
            ...
            System.out.println("Archivo Creado 'Optimizado.txt");
            escribir2.close();
            }
        catch(Exception e)
        {
...
//                    tablatripletas[conttrip][3] = "" + (apuntadorvueltafor + 1); 
                    ...
                    conttrip++;
            try{
            File archivo = new File("Triple.txt"); //Aquí va la direccion de las tripletas
    ...
    private void initComponents() {
        ...
        PanelGeneral.setBackground(new java.awt.Color(255, 204, 0));

        PanelSimbolos.setBackground(new java.awt.Color(255, 204, 0));
        ...
        PanelCodigo.setBackground(new java.awt.Color(255, 204, 0));
        ...
        PanelErrores.setBackground(new java.awt.Color(255, 204, 0));
        ...
        PanelBoton.setBackground(new java.awt.Color(255, 204, 0));
        ...
        jButton2.setText("Reiniciar Lectura");
        ...
        PanelBotonLayout.setVerticalGroup(
            ...
            .addGroup(PanelBotonLayout.createSequentialGroup()
                .addComponent(BtnDesplegar, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(28, 28, 28)
        ...
        PanelTripletas.setBackground(new java.awt.Color(255, 204, 0));
        PanelTripletas.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Tabla de Tripletas", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void BtnDesplegarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnDesplegarMouseClicked
        ...
        try{
            File archivo = new File("TEnsamblador.txt"); //Aquí va la direccion de las tripletas
            FileWriter escribir=new FileWriter(archivo,false);
